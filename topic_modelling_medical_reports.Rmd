...
```{r 3patients2, fig.cap="Selected patients alpha=0.2"}
...
```{r timeseriesplot, fig.cap="Time series bar-plot"}
...
ggplot(vizDataFrame, aes(x=year, y=value, fill=variable)) + 
  ...
  theme(axis.text.x = element_text(angle = 90, hjust = 1))
```
It appears the topic (dark purple) on sweats, chills, increased thirst, muscle pain and nausea which could be signs and symptoms of diabetics were on a surge at the beginning and the end of the time frame considered.
